...
# You can use this class to get a python file (used as a config file) in any directory and get it imported in your 
# program as a variable with method get_config or get_all.
# Also you can add additional cmdline argument options using object.parser.add_option as explained in the optparse 
# python documentation and then using get_all() method to obtain the parsed output
