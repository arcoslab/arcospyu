...
def vector_saturation(vector_min, vector_max, vector):
    angle_min_max = arccos(
        dot(vector_min, vector_max) / (norm(vector_min) * norm(vector_max)))
    angle_max = arccos(
...
def vector_saturation2(vector1, vector2, vector_test):
    ...
    # print 'vector1n', vector1n, 'vector2n', vector2n, 'vector test', vector_testn # noqa
    proj_vector1n = dot(vector_testn, vector1n)
    proj_vector2n = dot(vector_testn, vector2n)
    # if proj_vector1n<0. or proj_vector2n<0.:
    # print 'input vector not in the expected direction', proj_vector1n, proj_vector2n # noqa
    # return(array([0.,0.,0.]))
